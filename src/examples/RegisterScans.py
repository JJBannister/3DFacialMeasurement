...
atlas_mesh_file = './scans/atlas/atlas.ply'
atlas_landmark_file = './scans/atlas/atlas_lm_24.txt'

mesh_file = './scans/subjects/jordan.ply'
landmark_file = './scans/landmarks/jordan.txt'

out_file = './scans/registrations/jordan.ply'
...
lm._check_landmarks_3d(atlas_mesh, landmarks)
